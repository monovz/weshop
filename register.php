	...
	<form action="<?php echo BASE_URL."proses_register.php"; ?>" method="POST">
		...
		<?php
			...
			if($notif == "require") {
				...
				echo "<div class='notif'>Maaf, passwordmu tidak sama</div>";
			}else if($notif == "email") {
				echo "<div class='notif'>Maaf, email tersebut telah terdaftar</div>";
			}
		?>
		...
		<div class="element-form">
			<label>Alamat</label>
			<span><textarea name="alamat"><?php echo $email; ?></textarea></span>
		</div>
